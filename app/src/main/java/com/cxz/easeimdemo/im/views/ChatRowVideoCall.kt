...
class ChatRowVideoCall(context: Context?, isSender: Boolean) : EaseChatRow(context, isSender) {

    private var contentView: TextView? = null

    override fun onInflateView() {
        val layoutId =
            if (showSenderType) R.layout.ease_row_sent_video_call else R.layout.ease_row_received_video_call
